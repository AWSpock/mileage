...
<div class="content">
	<div class="row">
		<a href="/vehicle/<?php echo htmlentities($recVehicle->id()); ?>/reminder/create" class="button primary"><i class="fa-solid fa-plus"></i>Add Reminder</a>
	</div>
	<div class="row">
		...
		<div class="data-table" id="data-table">
			<div class="data-table-row header-row">
				...
				<div class="data-table-cell header-cell" data-id="due_months">
					<div class="data-table-cell-label">Due Months</div>
				</div>
				<div class="data-table-cell header-cell" data-id="due_miles">
					<div class="data-table-cell-label">Due Miles</div>
				</div>
				<div class="data-table-cell header-cell" data-id="due_date">
					<div class="data-table-cell-label">Due Date</div>
				</div>
				<div class="data-table-cell header-cell" data-id="due_odometer">
					<div class="data-table-cell-label">Due Odometer</div>
				</div>
...
<template id="template">
	<a href="/vehicle/VEHICLE_ID/reminder/REMINDER_ID/edit" class="data-table-row">
		...
		<div class="data-table-cell" data-id="due_months">
			<div class="data-table-cell-label">Due Months</div>
