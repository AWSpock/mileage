...
<div class="content">
    <form method="post" action="" id="frm" class="form-group main-form">
        ...
        <!-- <div class="input-group tag">
            ...
            <input type="text" id="trip.tag" name="trip.tag" class="form-control" required="required" value="<?php //echo htmlentities($recTrip->tag()); 
                                                                                                                ?>" list="tag-list" />
        ...
        <div class="button-group">
            ...
            <a href="/vehicle/<?php echo htmlentities($recVehicle->id()); ?>/trip/<?php echo htmlentities($recTrip->id()); ?>/summary" class="button secondary"><i class="fa-solid fa-ban"></i>Cancel</a>
