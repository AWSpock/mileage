...
<div class="content">
    <div class="row">
        ...
        <div class="renew-reminders">
            <h2>Renew Reminder</h2>
            <div class="reminders">
                <?php
                foreach ($reminders as $reminder) {
                ?>
                    <a href="/vehicle/<?php echo htmlentities($recVehicle->id()); ?>/reminder/<?php echo htmlentities($reminder->id()); ?>/edit?maintenance_id=<?php echo htmlentities($recMaintenance->id()); ?>"><?php echo htmlentities($reminder->name()); ?></a>
                <?php
                }
                ?>
            </div>
