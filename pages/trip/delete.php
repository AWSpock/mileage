...
<nav class="breadcrumbs">
    <ul>
        ...
        <li><a href="/vehicle/<?php echo htmlentities($recVehicle->id()); ?>/trip/<?php echo htmlentities($recTrip->id()); ?>/edit">Edit: <span><?php echo htmlentities($recTrip->name()); ?></span></a></li>
        <li>Delete</li>
    </ul>
</nav>
